...
export function Calendar({ selectedDate, onSelectDate }) {
    // Logic: Show 7 days before and 7 days after selected date to give context
    // This allows user to see past few days (if needed) or just focus on selected date
    // Array length 15: index 7 is the selected date (middle)
